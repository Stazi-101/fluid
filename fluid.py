...
def add_between(array, x, y, value):
    ...
    if x<0: int_x,dec_x = 0,0
    if y<0: int_y,dec_y = 0,0
    if x>array.shape[0]-2: int_x,dec_x = array.shape[0]-2,.99
    if y>array.shape[1]-2: int_y,dec_y = array.shape[1]-2,.99
